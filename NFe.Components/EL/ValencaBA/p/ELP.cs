...
using System;
using NFe.Components.PValencaBA;
using System.Net;
using System.Xml;

namespace NFe.Components.EL.ValencaBA.p
{
    public class ELP : EmiteNFSeBase
    {
        ...
        string UsuarioWs = string.Empty;
        string SenhaWs = string.Empty;
        string UsuarioProxy = string.Empty;
        string SenhaProxy = string.Empty;
        string DomainProxy = string.Empty;

        #region construtores

        public ELP(TipoAmbiente tpAmb, string pastaRetorno, string usuarioWs, string senhaWs, string usuarioProxy, string senhaProxy, string domainProxy)
