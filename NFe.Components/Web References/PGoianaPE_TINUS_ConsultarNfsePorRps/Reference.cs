...
namespace NFe.Components.PGoianaPE_TINUS_ConsultarNfsePorRps {
    ...
    public partial class tcIdentificacaoOrgaoGerador {
        ...
        public string Uf {
            get {
                return TrataUF(this.ufField);
            }
            set {
                this.ufField = TrataUF(value);
            }
        }

        private string TrataUF(string valor)
        {
    ...
    public partial class tcInfNfse {
        ...
        public string ValorCredito
        {
            get
            {
                return TrataDecimal(Convert.ToString(this.valorCreditoField));
            }
            set
            {
                this.valorCreditoField = TrataDecimal(Convert.ToString(value));
            }
        }
        ...
        private string TrataDecimal(string valor)
        {
            decimal resultado = 0;
